  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-foreground mb-4">Co chcesz dziś sprawdzić?</h1>
        <p className="text-lg text-muted-foreground">Wybierz narzędzie, które pomoże Ci zweryfikować treść</p>
      </div>
      ...
      <div className="mt-12 bg-muted rounded-2xl p-8 text-center">
        <h2 className="text-xl font-semibold text-foreground mb-2">Potrzebujesz pomocy?</h2>
        <p className="text-muted-foreground mb-4">
          Jeśli nie wiesz jak korzystać z narzędzi, sprawdź naszą sekcję FAQ lub skontaktuj się z nami.
        </p>
