...
import { ArrowRight, Shield, Mail, Image as ImageIcon, Lock } from 'lucide-react'
...
const Articles = () => {
  ...
  return (
    <div>
      <Header />
      <main className={cn("flex flex-col items-center justify-center mt-20 px-4 pb-16")}>
        ...
        <div className="max-w-4xl mx-auto mb-16 text-center">
          ...
          <p className="text-lg text-muted-foreground">
            Artykuły edukacyjne o tym, jak chronić się przed oszustami internetowymi. Pisane prostym językiem dla każdego.
          </p>
        </div>
                ...
                <div className="space-y-3 text-foreground leading-relaxed mb-8">
                  {article.content.map((paragraph, index) => (
                    <p 
                      ...
                      className={cn(
                        "text-base",
                        paragraph.startsWith('•') && "ml-4 text-muted-foreground",
                        (paragraph.endsWith(':') || paragraph.match(/^\d+\./)) && "font-semibold mt-4 text-foreground"
                      )}
                    >
                      {paragraph}
                    </p>
        ...
        <div className="max-w-4xl mx-auto w-full mt-16 p-8 bg-primary/5 border border-primary/20 rounded-2xl text-center">
          ...
          <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
            Sprawdź nasz poradnik krok po kroku, który wyjaśnia dokładnie jak korzystać z każdego narzędzia VeroAI.
          </p>
          <Link href="/tutorial">
